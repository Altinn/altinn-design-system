"use strict";var Ti=Object.defineProperty,Pi=Object.defineProperties;var Ni=Object.getOwnPropertyDescriptors;var St=Object.getOwnPropertySymbols;var Bi=Object.prototype.hasOwnProperty,Ri=Object.prototype.propertyIsEnumerable;var Mt=(A,x,y)=>x in A?Ti(A,x,{enumerable:!0,configurable:!0,writable:!0,value:y}):A[x]=y,Pe=(A,x)=>{for(var y in x||(x={}))Bi.call(x,y)&&Mt(A,y,x[y]);if(St)for(var y of St(x))Ri.call(x,y)&&Mt(A,y,x[y]);return A},Ne=(A,x)=>Pi(A,Ni(x));var kt=(A,x,y)=>new Promise((N,X)=>{var K=M=>{try{U(y.next(M))}catch(J){X(J)}},q=M=>{try{U(y.throw(M))}catch(J){X(J)}},U=M=>M.done?N(M.value):Promise.resolve(M.value).then(K,q);U((y=y.apply(A,x)).next())});(self.webpackChunk_altinn_altinn_design_system=self.webpackChunk_altinn_altinn_design_system||[]).push([[190],{78190:(A,x,y)=>{y.r(x),y.d(x,{Figspec:()=>xt,default:()=>Mi});var N=y(921),X=y.t(N,2);/**
 * @license
...
`+i.id;let l=nt.get(a);return l||(l=Ft(n.absoluteBoundingBox,i.absoluteBoundingBox),nt.set(a,l)),[...l.map(c=>Yt({guide:c,reverseScale:s})),...l.map(c=>Gt({guide:c,reverseScale:s,fontSize:r}))]},Kt=R`
  .distance-line {
    shape-rendering: geometricPrecision;
    fill: none;
    opacity: 0;
...
`,gi=n=>{if(!n||!n.link||n.link===void 0||n.link==="undefined")return null;const{link:i,timestamp:s,fileName:r}=n;return _`<a
  ...
  >
    ...
    >
      Edited ${pi(s)}
  ...
  </a>`};var ft=function(n,i,s,r){var a=arguments.length,l=a<3?i:r===null?r=Object.getOwnPropertyDescriptor(i,s):r,c;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")l=Reflect.decorate(n,i,s,r);else for(var p=n.length-1;p>=0;p--)(c=n[p])&&(l=(a<3?c(l):a>3?c(i,s,l):c(i,s))||l);return a>3&&l&&Object.defineProperty(i,s,l),l},C=function(n,i){if(!i.has(n))throw new TypeError("attempted to get private field on non-instance");return i.get(n)},Se=function(n,i,s){if(!i.has(n))throw new TypeError("attempted to set private field on non-instance");return i.set(n,s),s};const gt=n=>{var i,s,r,a,l;class c extends Vt(Wt(n)){constructor(...d){super(...d),this.zoomMargin=50,this.link="",i.set(this,void 0),s.set(this,void 0),r.set(this,void 0),a.set(this,h=>u=>{u.preventDefault(),u.stopPropagation(),this.selectedNode=h}),l.set(this,h=>{var u,f;return(f=(u=C(this,r))===null||u===void 0?void 0:u.find(g=>g.id===h))!==null&&f!==void 0?f:null})}static get styles(){const d=super.styles;return it(d,[R`
          :host {
        ...
        `,hi,Lt,Kt,ci,fi])}get __images(){return{}}deselectNode(){this.selectedNode=null}get error(){return!C(this,i)||!C(this,r)?Y({title:"Error",children:"Please call `__updateTree/1` method with a valid parameter."}):null}render(){if(this.error)return this.error instanceof Error?Y({title:this.error.name||"Error",children:this.error.message}):typeof this.error=="string"?Y({title:"Error",children:this.error}):this.error;const d=C(this,i),h=1/this.scale,u=`calc(var(--guide-thickness) * ${h})`,f=parseFloat(getComputedStyle(this).getPropertyValue("--guide-thickness")),g=parseFloat(getComputedStyle(this).getPropertyValue("--guide-tooltip-font-size"));return _`
...
`],[`
  ...
  bottom: 0;
  left: 0;
`])));function pe(n){return n.status!==200?Promise.reject(n.statusText):n.json()}function Si(n){var i;if(n.accessToken)return n.accessToken;try{return(i=wi.env.STORYBOOK_FIGMA_ACCESS_TOKEN)!==null&&i!==void 0?i:null}catch(s){return null}}var xt=function(n){var i=n.config,s=(0,N.useState)({state:"loading"}),r=s[0],a=s[1],l=function(c){return Ei(void 0,void 0,void 0,function(){var p,d,h,u,f,g,v,m,b,w,P,Te,Et,Ct,z;return Ci(this,function(j){switch(j.label){case 0:a({state:"loading"}),j.label=1;case 1:if(j.trys.push([1,6,,7]),p=i.url.match(xi.sC),!p)throw new Error(i.url+" is not a valid Figma URL.");if(d=p[3],h=new URL(i.url),u=h.searchParams.get("node-id"),f=Si(i),!f)throw new Error("Personal Access Token is required.");return g={"X-FIGMA-TOKEN":f},v=new URL("https://api.figma.com/v1/files/"+d),m=new URL("https://api.figma.com/v1/images/"+d),m.searchParams.set("format","svg"),u?[3,4]:[4,fetch(v.href,{headers:g,signal:c}).then(pe)];case 2:return b=j.sent(),w=wt(b.document),m.searchParams.set("ids",w.map(function(ki){return ki.id}).join(",")),[4,fetch(m.href,{headers:g,signal:c}).then(pe)];case 3:return P=j.sent(),a({state:"fetched",value:{type:"file",props:{documentNode:b,renderedImages:P.images,link:i.url}}}),[2];case 4:return v.pathname+="/nodes",v.searchParams.set("ids",u),m.searchParams.set("ids",u),[4,Promise.all([fetch(v.href,{headers:g,signal:c}).then(pe),fetch(m.href,{headers:g,signal:c}).then(pe)])];case 5:return Te=j.sent(),Et=Te[0],Ct=Te[1],a({state:"fetched",value:{type:"frame",props:{nodes:Et,renderedImage:Object.values(Ct.images)[0],link:i.url}}}),[3,7];case 6:return z=j.sent(),z instanceof DOMException&&z.code===DOMException.ABORT_ERR?[2]:(console.error(z),a({state:"failed",error:z instanceof Error?z.message:String(z)}),[3,7]);case 7:return[2]}})})};switch((0,N.useEffect)(function(){var c=!1,p=function(){c=!0},d=new AbortController;return l(d.signal).then(p,p),function(){c||d.abort()}},[i.url]),r.state){case"loading":return(0,B.tZ)(_t.V,null,(0,B.tZ)(N.Fragment,null,"Loading Figma file..."));case"failed":return(0,B.tZ)(_t.V,null,(0,B.tZ)(N.Fragment,null,"Failed to load Figma file"),(0,B.tZ)(N.Fragment,null,r.error));case"fetched":return r.value.type==="file"?(0,B.tZ)($i,ue({css:$t},r.value.props)):(0,B.tZ)(_i,ue({css:$t},r.value.props))}};const Mi=xt;function wt(n){return"absoluteBoundingBox"in n?[n]:!n.children||n.children.length===0?[]:n.children.map(wt).flat()}var At}}]);
